    ...
    return (
        <footer className="flex flex-col items-center py-10 justify-between bg-[#252641]">
            <div className="w-full md:w-72 flex items-center justify-center">
                ...
                <hr className="border-l mx-5 md:mx-10 h-14" />
            ...
            <div className="mb-10 flex flex-col md:flex-row gap-y-3">
                <input className="rounded-full bg-transparent border border-gray-500 px-4 md:mr-4 py-2 w-full md:w-72 placeholder:text-sm outline-none" type="email" placeholder="Your Email" />
                <div>
